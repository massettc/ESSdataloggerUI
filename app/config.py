...
class Config:
    ...
    APP_PORT = int(os.getenv("PI_ADMIN_PORT", "8181"))
    ...
    ETHERNET_MAC_ADDRESS = os.getenv("PI_ADMIN_ETHERNET_MAC_ADDRESS", "dc:a6:32:2e:8b:12")
    ...
    DATALOGGER_STATUS_CACHE_SECONDS = float(os.getenv("PI_ADMIN_DATALOGGER_STATUS_CACHE_SECONDS", "5"))
    DATALOGGER_COMMAND_TIMEOUT_SECONDS = int(os.getenv("PI_ADMIN_DATALOGGER_COMMAND_TIMEOUT_SECONDS", "4"))
    ...
    STATUS_CACHE_SECONDS = float(os.getenv("PI_ADMIN_STATUS_CACHE_SECONDS", "5"))
    WIFI_SCAN_CACHE_SECONDS = float(os.getenv("PI_ADMIN_WIFI_SCAN_CACHE_SECONDS", "20"))
    COMMAND_TIMEOUT_SECONDS = int(os.getenv("PI_ADMIN_COMMAND_TIMEOUT_SECONDS", "15"))
    WIFI_CONNECT_TIMEOUT_SECONDS = int(os.getenv("PI_ADMIN_WIFI_CONNECT_TIMEOUT_SECONDS", "45"))
    ...
    EXTRA_ETHERNET_ROUTE_METRIC = int(os.getenv("PI_ADMIN_EXTRA_ETHERNET_ROUTE_METRIC", "300"))
